...
const House = ({ house }) => {
	...
	return (
		<>
			<div className='bg-transparent hover:backdrop-blur-2xl shadow-1 p-5 rounded-lg rounded-tl-[90px] w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl  transition-all '>
				<img
					className='mb-8'
					src={image}
					alt=''
